...
// Connecting to the Bamazon Database in mysql
...
var stopApp = function(){
    console.log("\nThank you for shopping at bamazon :D , see you again .");
}
...
var beginApp = function(){
    ...
    var getBamazonProducts = function (products){
        console.log("\nHello, Welcome to Bamazon! Here are all of the products, their costs, and current stock.");
